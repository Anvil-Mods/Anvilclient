...
public class Keybinds
{
    ...
    public static final KeyBinding autoTool = new KeyBinding("anvilclient.configGui.autoTool.toggle", KeyConflictContext.IN_GAME, InputMappings.Type.KEYSYM, GLFW.GLFW_KEY_UNKNOWN, keyCategory);
