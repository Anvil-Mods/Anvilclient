...
public class BedwarsInfo extends Feature {
	...
	//
	//	private static final String REJOIN_TEXT = "\u00A7e\u00A7lTo leave Bed Wars, type
	// /lobby\u00A7r";
	//
	...
	//
	//	@Override
	//	public void render(ForgeGui gui, PoseStack poseStack, float partialTicks, int width, int
	// height) {
	...
	//					int[] times = Arrays.stream(stageTime.trim().replace(stage.getName() + " in ",
	// "").split(":"))
	...
	//
	//	private enum Stages {
	//		DIAMOND2(6 * 60, "Diamond II"), EMERALD2(12 * 60, "Emerald II"), DIAMOND3(18 * 60, "Diamond
	// III"),
	//		EMERALD3(24 * 60, "Emerald III"), BED_GONE(30 * 60, "Bed Gone"), SUDDEN_DEATH(40 * 60, "Sudden
	// Death"),
